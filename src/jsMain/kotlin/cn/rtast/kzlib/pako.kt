...
private external object Pako {
    ...
    class Deflate(options: Any = definedExternally) {
        ...
        fun push(data: Uint8Array, @Suppress("localVariableName") flush_mode: Int): Boolean
    }
...
internal enum class ZStatus(val status: Int) {
    ...
    val isError: Boolean get() = status < 0
...
internal class Deflate(
    ...
    val err: ZStatus get() = ZStatus.fromCode(deflate.err)
...
internal class Inflate(windowBits: Int? = null) {
    ...
    val err: ZStatus get() = ZStatus.fromCode(inflate.err)
